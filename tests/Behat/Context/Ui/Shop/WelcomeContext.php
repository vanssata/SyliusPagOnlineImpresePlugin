...
namespace Tests\Vanssata\SyliusPagOnlineImpresePlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Vanssata\SyliusPagOnlineImpresePlugin\Behat\Page\Shop\WelcomePageInterface;
